...
def _df_tensors_to_params(
    ...
    # print("core_param_indices")
    # print(core_param_indices)
    # print("core_params")
    # print(diag_coulomb_mats[0][core_param_indices])
    # print("diag_coulomb_mats[0]")
    # print(diag_coulomb_mats[0])
    # input()
...
def double_factorized_t2_compress(
    ...
    *,
    ...
    # masked_diag_coulomb_mats = diag_coulomb_mats[:] * diag_coulomb_mask

    diag_coulomb_mask = np.triu(diag_coulomb_mask)
    # print(diag_coulomb_mask)
    ...
    # print(np.allclose(masked_diag_coulomb_mats, diag_coulomb_mats_converted))
