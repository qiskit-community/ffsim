...
"""Generate docs/api/ffsim.rst from python/ffsim/__init__.py.

Run this script after adding or removing symbols from the ffsim package:

    python docs/generate_api_docs.py

The section headings are read from the first line of each submodule's
docstring, and the remainder of the docstring is included as a paragraph.
To change a heading or description, edit the corresponding module docstring
